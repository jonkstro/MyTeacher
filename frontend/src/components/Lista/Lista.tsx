                    ...
                    {props.professores.map(professor => (
                        <ItemLista key={professor.id}>
                            ...
                            <Informacoes>
                                ...
                                <Descricao>{FormatadorService.limitarTexto (professor.descricao, 20)}</Descricao>
                                <Button onClick={() => props.onSelect(professor)} sx={{ width: '100%' }}>Marcar Aula com {professor.nome}</Button>
                            </Informacoes>
                        </ItemLista>
                    ))}
                </ListaStyled>
